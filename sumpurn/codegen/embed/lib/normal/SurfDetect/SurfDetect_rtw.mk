###########################################################################
## Makefile generated for MATLAB file/project 'SurfDetect'. 
## 
## Makefile     : SurfDetect_rtw.mk
## Generated on : Tue Jan 23 10:00:03 2018
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\SurfDetect.lib
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\Sumpurn\Projects\GPU\gpucoderdemo_feature_extraction
ARCH                      = win64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\SurfDetect.lib
...
INCLUDES_BUILDINFO = $(START_DIR)\sumpurn\codegen\embed\lib\normal\SurfDetect;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
DEFINES_STANDARD = -D MODEL=SurfDetect -D HAVESTDIO -D USE_RTMODEL
...
SRCS = $(START_DIR)\sumpurn\codegen\embed\lib\normal\SurfDetect\SurfDetect_initialize.cu $(START_DIR)\sumpurn\codegen\embed\lib\normal\SurfDetect\SurfDetect_terminate.cu $(START_DIR)\sumpurn\codegen\embed\lib\normal\SurfDetect\SurfDetect.cu $(START_DIR)\sumpurn\codegen\embed\lib\normal\SurfDetect\rt_nonfinite.cu $(START_DIR)\sumpurn\codegen\embed\lib\normal\SurfDetect\rtGetNaN.cu $(START_DIR)\sumpurn\codegen\embed\lib\normal\SurfDetect\rtGetInf.cu
...
OBJS = SurfDetect_initialize.obj SurfDetect_terminate.obj SurfDetect.obj rt_nonfinite.obj rtGetNaN.obj rtGetInf.obj
...
{$(START_DIR)\sumpurn\codegen\embed\lib\normal\SurfDetect}.cu.obj :
	$(CC) $(CFLAGS) -o  "$@" "$<"


{$(START_DIR)\sumpurn\codegen\embed\lib\normal\SurfDetect}.c.obj :
	$(CC) $(CFLAGS) -o  "$@" "$<"
